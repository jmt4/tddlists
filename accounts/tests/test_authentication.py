...
class AuthenticateTest(TestCase):
	...
	def test_authenticate_returns_None_if_response_errors(self, mock_post):
...
class GetUserTest(TestCase):
	...
	def test_gets_user_email(self):
		...
		mystical_user = User(email='mystical@user.com')
		mystical_user.username = 'mysticaluser'
		mystical_user.save()
	...
	def test_get_user_returns_None_if_no_user_with_that_email(self):
		backend = PersonaAuthenticationBackend()
