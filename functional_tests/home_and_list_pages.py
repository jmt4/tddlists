...
class HomePage(object):
	...
	def __init__(self, test):
		# self.test is a test object like FunctionalTest
		self.test = test

	def go_to_home_page(self):
		# Most PagePattern designs have a method to get the
		# desired web page
		self.test.browser.get(self.test.server_url)
		# wait_for() expects a function
		## We wait for an element we know is on the page
	...
	def start_new_list(self, item_text):
		...
		# Another page in our PagePattern design
		list_page = ListPage(self.test)
		# wait to make sure a new item/list was created/added
